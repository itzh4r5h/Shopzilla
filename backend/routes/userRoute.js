...
const {getAllUsers, getSingleUser, updateUserRole, deleteUser, getUser, updateUserName, updateUserEmail, updateUserProfilePic, updateUserPassword} = require('../controllers/user/profileContoller')
...
router.route('/admin/users/:id').get(isUserAuthenticated,authorizedRoles('admin'),getSingleUser).patch(isUserAuthenticated,authorizedRoles('admin'),updateUserRole).delete(isUserAuthenticated,authorizedRoles('admin'),deleteUser)
