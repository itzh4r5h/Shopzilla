...
router.route('/orders/:id').post(isUserAuthenticated,createNewOrder).get(isUserAuthenticated,getMyOrder).delete(isUserAuthenticated,deleteOrderAndPaymentOrder)
